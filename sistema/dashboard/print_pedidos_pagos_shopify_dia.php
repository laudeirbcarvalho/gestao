...
// Consulta os pedidos do dia atual
$sql = "SELECT 
...
WHERE w.status = 'integrado' 
  ...
  AND DATE(w.data_hora) = CURDATE()  -- This line filters for the current day
...
if ($result->num_rows > 0) {
    ...
    echo "<h1>Pedidos Pagos em " . date('d/m/Y') . " ($nomeprojetoshopify)</h1>"; // Título dinâmico com a data atual
    ...
    echo "Não há pedidos pagos para o dia atual.";
}
